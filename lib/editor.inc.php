...
function show_editor_startpage()
{
 ...
 global $observium_found, $ignore_observium;
	...
	print 'Named (must include ".conf"): <input type="text" name="mapname" size="20">';
	...
	print '<form method="GET">';
	print 'Named (must include ".conf"): <input type="text" name="mapname" size="20"> based on ';
